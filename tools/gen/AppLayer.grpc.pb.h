 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status CheckToken(::grpc::ClientContext* context, const ::Token& request, ::Error* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::Error>> AsyncCheckToken(::grpc::ClientContext* context, const ::Token& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::Error>>(AsyncCheckTokenRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::Error>> PrepareAsyncCheckToken(::grpc::ClientContext* context, const ::Token& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::Error>>(PrepareAsyncCheckTokenRaw(context, request, cq));
    }
    class experimental_async_interface {
     public:
      ...
      #endif
      virtual void CheckToken(::grpc::ClientContext* context, const ::Token* request, ::Error* response, std::function<void(::grpc::Status)>) = 0;
      virtual void CheckToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Error* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void CheckToken(::grpc::ClientContext* context, const ::Token* request, ::Error* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void CheckToken(::grpc::ClientContext* context, const ::Token* request, ::Error* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void CheckToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Error* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void CheckToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Error* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::Error>* AsyncCheckTokenRaw(::grpc::ClientContext* context, const ::Token& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::Error>* PrepareAsyncCheckTokenRaw(::grpc::ClientContext* context, const ::Token& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status CheckToken(::grpc::ClientContext* context, const ::Token& request, ::Error* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::Error>> AsyncCheckToken(::grpc::ClientContext* context, const ::Token& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::Error>>(AsyncCheckTokenRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::Error>> PrepareAsyncCheckToken(::grpc::ClientContext* context, const ::Token& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::Error>>(PrepareAsyncCheckTokenRaw(context, request, cq));
    }
    class experimental_async final :
     ...
     public:
      ...
      #endif
      void CheckToken(::grpc::ClientContext* context, const ::Token* request, ::Error* response, std::function<void(::grpc::Status)>) override;
      void CheckToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Error* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void CheckToken(::grpc::ClientContext* context, const ::Token* request, ::Error* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void CheckToken(::grpc::ClientContext* context, const ::Token* request, ::Error* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void CheckToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Error* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void CheckToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Error* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::Error>* AsyncCheckTokenRaw(::grpc::ClientContext* context, const ::Token& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::Error>* PrepareAsyncCheckTokenRaw(::grpc::ClientContext* context, const ::Token& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status CheckToken(::grpc::ServerContext* context, const ::Token* request, ::Error* response);
  };
  ...
  class WithAsyncMethod_CheckToken : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status CheckToken(::grpc::ServerContext* /*context*/, const ::Token* /*request*/, ::Error* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestCheckToken(::grpc::ServerContext* context, ::Token* request, ::grpc::ServerAsyncResponseWriter< ::Error>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class ExperimentalWithCallbackMethod_CheckToken : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_CheckToken() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(6,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::Token, ::Error>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::Token* request, ::Error* response) { return this->CheckToken(context, request, response); }));}
    void SetMessageAllocatorFor_CheckToken(
        ::grpc::experimental::MessageAllocator< ::Token, ::Error>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(6);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(6);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::Token, ::Error>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* CheckToken(
      ::grpc::CallbackServerContext* /*context*/, const ::Token* /*request*/, ::Error* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* CheckToken(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::Token* /*request*/, ::Error* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    WithStreamedUnaryMethod_CheckToken() {
      ::grpc::Service::MarkMethodStreamed(6,
        new ::grpc::internal::StreamedUnaryHandler< ::Token, ::Error>(std::bind(&WithStreamedUnaryMethod_CheckToken<BaseClass>::StreamedCheckToken, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedCheckToken(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::Token,::Error>* server_unary_streamer) = 0;
  };
