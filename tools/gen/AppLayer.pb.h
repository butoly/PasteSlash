...
class Code :
 ...
 public:
  ...
  ::Hash* release_hash();
  ::Hash* mutable_hash();
  void set_allocated_hash(::Hash* hash);
  private:
  const ::Hash& _internal_hash() const;
  ::Hash* _internal_mutable_hash();
  public:
...
// .Hash hash = 3;
inline bool Code::_internal_has_hash() const {
  return this != internal_default_instance() && hash_ != nullptr;
}
inline bool Code::has_hash() const {
  return _internal_has_hash();
}
inline void Code::clear_hash() {
  if (GetArenaNoVirtual() == nullptr && hash_ != nullptr) {
    delete hash_;
  }
  hash_ = nullptr;
}
inline const ::Hash& Code::_internal_hash() const {
  const ::Hash* p = hash_;
  return p != nullptr ? *p : *reinterpret_cast<const ::Hash*>(
      &::_Hash_default_instance_);
}
inline const ::Hash& Code::hash() const {
  // @@protoc_insertion_point(field_get:Code.hash)
  return _internal_hash();
}
inline ::Hash* Code::release_hash() {
  // @@protoc_insertion_point(field_release:Code.hash)
  
  ::Hash* temp = hash_;
  hash_ = nullptr;
  return temp;
}
inline ::Hash* Code::_internal_mutable_hash() {
  
  if (hash_ == nullptr) {
    auto* p = CreateMaybeMessage<::Hash>(GetArenaNoVirtual());
    hash_ = p;
  }
  return hash_;
}
inline ::Hash* Code::mutable_hash() {
  // @@protoc_insertion_point(field_mutable:Code.hash)
  return _internal_mutable_hash();
}
inline void Code::set_allocated_hash(::Hash* hash) {
  ...
  hash_ = hash;
  // @@protoc_insertion_point(field_set_allocated:Code.hash)
}
