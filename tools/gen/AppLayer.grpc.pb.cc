...
AppLayer::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_GetAllHashes_(AppLayer_method_names[5], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
...
::grpc::ClientReader< ::Hash>* AppLayer::Stub::GetAllHashesRaw(::grpc::ClientContext* context, const ::User& request) {
  return ::grpc_impl::internal::ClientReaderFactory< ::Hash>::Create(channel_.get(), rpcmethod_GetAllHashes_, context, request);
}

void AppLayer::Stub::experimental_async::GetAllHashes(::grpc::ClientContext* context, ::User* request, ::grpc::experimental::ClientReadReactor< ::Hash>* reactor) {
  ::grpc_impl::internal::ClientCallbackReaderFactory< ::Hash>::Create(stub_->channel_.get(), stub_->rpcmethod_GetAllHashes_, context, request, reactor);
}

::grpc::ClientAsyncReader< ::Hash>* AppLayer::Stub::AsyncGetAllHashesRaw(::grpc::ClientContext* context, const ::User& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::Hash>::Create(channel_.get(), cq, rpcmethod_GetAllHashes_, context, request, true, tag);
}

::grpc::ClientAsyncReader< ::Hash>* AppLayer::Stub::PrepareAsyncGetAllHashesRaw(::grpc::ClientContext* context, const ::User& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncReaderFactory< ::Hash>::Create(channel_.get(), cq, rpcmethod_GetAllHashes_, context, request, false, nullptr);
}

::grpc::Status AppLayer::Stub::CheckToken(::grpc::ClientContext* context, const ::Token& request, ::Error* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_CheckToken_, context, request, response);
}

void AppLayer::Stub::experimental_async::CheckToken(::grpc::ClientContext* context, const ::Token* request, ::Error* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_CheckToken_, context, request, response, std::move(f));
}

void AppLayer::Stub::experimental_async::CheckToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Error* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_CheckToken_, context, request, response, std::move(f));
}

void AppLayer::Stub::experimental_async::CheckToken(::grpc::ClientContext* context, const ::Token* request, ::Error* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void AppLayer::Stub::experimental_async::CheckToken(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::Error* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_CheckToken_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::Error>* AppLayer::Stub::AsyncCheckTokenRaw(::grpc::ClientContext* context, const ::Token& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::Error>::Create(channel_.get(), cq, rpcmethod_CheckToken_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::Error>* AppLayer::Stub::PrepareAsyncCheckTokenRaw(::grpc::ClientContext* context, const ::Token& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::Error>::Create(channel_.get(), cq, rpcmethod_CheckToken_, context, request, false);
}
...
AppLayer::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ServerStreamingHandler< AppLayer::Service, ::User, ::Hash>(
          std::mem_fn(&AppLayer::Service::GetAllHashes), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      AppLayer_method_names[6],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< AppLayer::Service, ::Token, ::Error>(
...
::grpc::Status AppLayer::Service::GetAllHashes(::grpc::ServerContext* context, const ::User* request, ::grpc::ServerWriter< ::Hash>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status AppLayer::Service::CheckToken(::grpc::ServerContext* context, const ::Token* request, ::Error* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
