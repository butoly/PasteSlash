...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Code_AppLayer_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Code_AppLayer_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_AppLayer_2eproto[5];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_AppLayer_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Code, hash_),
};
...
const char descriptor_table_protodef_AppLayer_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001 \001(\t\"\025\n\004Hash\022\r\n\005value\030\001 \001(\t\"7\n\004Code\022\014\n\004"
  "name\030\001 \001(\t\022\014\n\004text\030\002 \001(\t\022\023\n\004hash\030\003 \001(\0132\005"
  ".Hash2\334\001\n\010AppLayer\022\033\n\010AuthUser\022\005.User\032\006."
  "Token\"\000\022\032\n\007RegUser\022\005.User\032\006.Token\"\000\022\033\n\tS"
  "toreCode\022\005.Code\032\005.Hash\"\000\022\031\n\007GetCode\022\005.Ha"
  "sh\032\005.Code\"\000\022\035\n\nDeleteCode\022\005.Hash\032\006.Error"
  "\"\000\022 \n\014GetAllHashes\022\005.User\032\005.Hash\"\0000\001\022\036\n\n"
  "CheckToken\022\006.Token\032\006.Error\"\000b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_AppLayer_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_AppLayer_2eproto_sccs[5] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_AppLayer_2eproto = {
  &descriptor_table_AppLayer_2eproto_initialized, descriptor_table_protodef_AppLayer_2eproto, "AppLayer.proto", 436,
  &descriptor_table_AppLayer_2eproto_once, descriptor_table_AppLayer_2eproto_sccs, descriptor_table_AppLayer_2eproto_deps, 5, 0,
  schemas, file_default_instances, TableStruct_AppLayer_2eproto::offsets,
  file_level_metadata_AppLayer_2eproto, 5, file_level_enum_descriptors_AppLayer_2eproto, file_level_service_descriptors_AppLayer_2eproto,
};
...
void Code::InitAsDefaultInstance() {
  ::_Code_default_instance_._instance.get_mutable()->hash_ = const_cast< ::Hash*>(
      ::Hash::internal_default_instance());
}
class Code::_Internal {
 public:
  static const ::Hash& hash(const Code* msg);
};

const ::Hash&
Code::_Internal::hash(const Code* msg) {
  return *msg->hash_;
}
Code::Code()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
...
// @@protoc_insertion_point(message_clear_start:Code)
  ...
  if (GetArenaNoVirtual() == nullptr && hash_ != nullptr) {
    delete hash_;
  }
  hash_ = nullptr;
  _internal_metadata_.Clear();
  ...
  if (this->has_hash()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        3, _Internal::hash(this), target, stream);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Code)
  ...
  if (from.has_hash()) {
    _internal_mutable_hash()->::Hash::MergeFrom(from._internal_hash());
  }
}
