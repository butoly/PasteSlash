...
public:
    ...
    static bool deleteUser(const std::string& nickname);

    static bool updateUser(const std::string& nickname,
    ...
    static void updateToken(const std::string& nickname,
                            const std::string& newToken, int dayOfLiving = 2);
